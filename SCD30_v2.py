...
def stratosPost():
    ...
    sensor = SCD30_Modbus('/dev/serial0')
    sensor.initPort()
    running = True
    readings = sensor.readMeasurements()
    
    sensor1 = readings[0] #co2
    sensor2 = (readings[1] - 2.5) #temp
    sensor3 =  readings[2] #humidity
    ...
    dataStratos = {
        ...
        "body": [
                ...
                {
                "name": 'BHGE_DS_MC_LEIC_TEST_TEMP' ,
                "datapoints": [
                    [
                        timeTS,
                        sensor2
                                ...
                                {
                "name": 'BHGE_DS_MC_LEIC_TEST_HUMID' ,
                "datapoints": [
                    [
                        timeTS,
                        sensor3
